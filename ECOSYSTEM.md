...
* [axios-retry-proxy](https://github.com/keith-hon/axios-retry-proxy) -  Add retry functions and additional proxy configuration to axios with typescript support
