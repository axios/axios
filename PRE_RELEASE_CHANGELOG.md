...
- **Request error stacks:** Preserved short reconstructed caller stacks when stack capture returns fewer than three frames, preventing one- and two-frame caller traces from being dropped during error stack decoration. (closes **#11131**)
