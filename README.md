...
> Note: here by JSON we mean an object consisting only of string values, intended for subsequent sending over the network
...
Returns `true` if the header is set (has not `undefined` value).
