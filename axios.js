...
var buildUrl = _dereq_('./../buildUrl');
var cookies = _dereq_('./../cookies');
var defaults = _dereq_('./../defaults');
var parseHeaders = _dereq_('./../parseHeaders');
var transformData = _dereq_('./../transformData');
var urlIsSameOrigin = _dereq_('./../urlIsSameOrigin');
...
},{"./../buildUrl":4,"./../cookies":5,"./../defaults":6,"./../parseHeaders":7,"./../transformData":9,"./../urlIsSameOrigin":10,"./../utils":11}],3:[function(_dereq_,module,exports){
(function (process){
var Promise = _dereq_('es6-promise').Promise;
var defaults = _dereq_('./defaults');
var utils = _dereq_('./utils');
var spread = _dereq_('./spread');
  ...
  var promise = new Promise(function (resolve, reject) {
    try {
      ...
      if (typeof window !== 'undefined') {
        _dereq_('./adapters/xhr')(resolve, reject, config);
      }
      // For node use HTTP adapter
      else if (typeof process !== 'undefined') {
        _dereq_('./adapters/http')(resolve, reject, config);
      }
    } catch (e) {
      reject(e);
    }
...
},{"./adapters/http":2,"./adapters/xhr":2,"./defaults":6,"./spread":8,"./utils":11,"/usr/local/lib/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":22,"es6-promise":12}],4:[function(_dereq_,module,exports){
'use strict';
...
},{"./utils":11}],5:[function(_dereq_,module,exports){
'use strict';
...
},{"/usr/local/lib/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":22}],15:[function(_dereq_,module,exports){
"use strict";
var config = {
  instrument: false
};
