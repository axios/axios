...
| v2 Node/ESM direction   | Maintainer directives supplied 2026-08-20; Plan 001; current manifests, Rollup config, and CI workflows | Node 20+ matrix-verified on PR #11161; ESM-only remains intent | Plan 001 completion audit and archival remain                                |
