...
let alias = require('@rollup/plugin-alias').default;
...
function setupKarmaConfig(
  config,
  browsersOverride,
  filesOverride,
  preprocessorsOverride,
) {
  var customLaunchers = {};
  ...
  config.set({
    ...
    preprocessors: preprocessorsOverride || {
    ...
    browsers: browsersOverride || browsers,
