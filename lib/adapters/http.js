...
module.exports = function httpAdapter(resolve, reject, config) {
  ...
  var req = transport.request(options, function handleResponse(res) {
    ...
    console.log(res.headers['Content-Length'], Number(res.headers['Content-Length']), config.maxContentLength);
    if (config.maxContentLength > -1 && Number(res.headers['Content-Length']) > config.maxContentLength) {
