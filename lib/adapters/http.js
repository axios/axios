...
module.exports = function httpAdapter(config) {
  return new Promise(function dispatchHttpRequest(
    ...
    var httpAgent = configProxy === false ? getDirectAgent(config.httpAgent, http) : config.httpAgent;
    var httpsAgent = configProxy === false ? getDirectAgent(config.httpsAgent, https) : config.httpsAgent;
    var options = {
      path: buildURL(
        parsed.path,
        config.params,
