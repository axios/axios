...
var AxiosTransformStream = require('../helpers/AxiosTransformStream');
...
module.exports = function httpAdapter(config) {
  return new Promise(function dispatchHttpRequest(resolvePromise, rejectPromise) {
    ...
    var headers = AxiosHeaders.from(config.headers).normalize();
    ...
    // Send the request
    if (utils.isStream(data)) {
      stream.pipeline(data, req, function(err) {
        if (err) {
