...
function getTunnelingAgent(agentOptions, userHttpsAgent) {
  ...
  // so its options have to reach the tunneled origin too.
  const originAgent = userHttpsAgent || https.globalAgent;
  if (originAgent && originAgent.options) {
    const originTLSOptions = { ...originAgent.options };
