  ...
  function (config) {
    return new Promise(function dispatchXhrRequest(resolve, reject) {
      ...
      function onloadend() {
        ...
        // status 0 on success, are excluded by the request URL's scheme, by the page origin's
        // scheme for relative URLs (which inherit it), or by responseURL where implemented.
        if (
          request.status === 0 &&
          (parseProtocol(_config.url) || parseProtocol(platform.origin)) !== 'file' &&
