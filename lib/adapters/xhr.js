  ...
  function (config) {
    return new Promise(function dispatchXhrRequest(resolve, reject) {
      ...
      function onloadend() {
        ...
        // status 0 on success, are excluded by either the request URL or the response URL:
        // a page loaded from file: may request a relative path that carries no scheme, and
        // responseURL is unavailable in some of the environments where this matters.
        if (
          request.status === 0 &&
          parseProtocol(_config.url) !== 'file' &&
