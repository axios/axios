  ...
  function (config) {
    return new Promise(function dispatchXhrRequest(resolve, reject) {
      ...
      function onloadend(event) {
        ...
        // The loadend event is still dispatching, so flushing with it gives
        // progress listeners a final delivery whose event has a live target.
        ...
        try {
          flushDownload && flushDownload(event);
        } catch (err) {
          setTimeout(() => {
            throw err;
          });
