      ...
      if (err instanceof Error) {
        try {
          ...
          if (!err.stack) {
            ...
            // When the reconstructed stack has fewer than 3 lines, there's no
            // "remainder after the top two lines" to slice off -- comparing
            // against the full stack (instead of '', which every string
            // trivially ends with) keeps the duplicate check meaningful for
            // shallow stacks too.
