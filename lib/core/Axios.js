...
class Axios {
  ...
  _request(configOrUrl, config) {
    ...
    // defaults when it holds an object; a literal value under one of those
    // names, eg the `Link` request header, is a header to send.
    const isHeadersBucket = (value) =>
      value == null || (utils.isObject(value) && !utils.isArray(value));
