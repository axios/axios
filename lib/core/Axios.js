        ...
        try {
          ...
          if (!errStack) {
            ...
            const firstFilePath = filePathMatch
              ...
              : '';
            // If firstFilePath is empty (non-V8 engine or unrecognised frame
            // format), fall through and always append — it is better to have a
            // slightly longer trace than to silently drop caller frames on
            // engines whose stack format differs from V8's.
