        ...
        try {
          ...
          if (!err.stack) {
            ...
            const stackWithoutTwoTopLines =
              secondNewlineIndex === -1 ? null : stack.slice(secondNewlineIndex + 1);

            // a stack of one or two lines leaves nothing to compare against
            if (
              stackWithoutTwoTopLines === null ||
