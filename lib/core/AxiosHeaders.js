...
function parseTokens(str) {
  ...
  while ((match = tokensRE.exec(str))) {
    ...
    if (value !== undefined) {
      value = value.trim();
      // Strip surrounding double-quotes per RFC 9110 §5.6.4 (quoted-string):
      // parameter values may be transmitted as quoted strings; the DQUOTE
      // delimiters are not part of the value itself.
