...
import assertParamsDepth from '../helpers/assertParamsDepth.js';
...
export default function mergeConfig(config1, config2) {
  ...
  assertParamsDepth(utils.hasOwnProp(config1, 'params') ? config1.params : undefined);
  assertParamsDepth(utils.hasOwnProp(config2, 'params') ? config2.params : undefined);
