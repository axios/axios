...
function encodeArrayItem(items, key, val) {
  items.push(key + '[]=' + encode(utils.isDate(val) ? val.toISOString() : val));
}
    ...
    if (Object.prototype.hasOwnProperty.call(params, field)) {
      ...
      case 'object':
        ...
        if (params[field].constructor === Array) {
          ...
          items.push(key + '=' + params[field].toISOString());
        } else {
      ...
      case 'function':
        break;
      default:
        items.push(key + '=' + encode(params[field]));
        break;
      }
    }
  }
