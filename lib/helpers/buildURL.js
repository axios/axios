...
export default function buildURL(url, params, options) {
  ...
  if (url === null) {
    ...
    try {
      ...
      // Accessing 'href' on a malformed URL-like object can throw a TypeError
      // (e.g. if the object has a getter that crashes). Catch it to ensure
      // we return the promised AxiosError instead of a native crash.
      href = undefined;
    }
