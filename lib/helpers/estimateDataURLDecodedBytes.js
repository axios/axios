...
// ASCII whitespace, which is both the set forgiving-base64 decoding ignores and
// the set stripped from a data: URL media type.
...
const isBase64MediaType = (meta) => {
  ...
  while (end > 0 && isASCIIWhitespace(meta.charCodeAt(end - 1))) {
    end--;
  }
