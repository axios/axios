...
/**
 * Determine whether an object is the standard Object.prototype for its realm.
 * Cross-realm objects do not inherit from this realm's Object.prototype, so an
 * identity comparison alone cannot identify the shared-prototype boundary.
 *
 * @param {*} obj The object to inspect
 *
 * @returns {boolean} True when obj is a realm's standard Object.prototype
 */
const isObjectPrototype = (obj, prototype) => {
  if (obj === Object.prototype) {
    return true;
  }

  if (obj == null || prototype !== null) {
    return false;
  }
...
const hasOwnInPrototypeChain = (thing, prop) => {
  ...
  while (obj != null) {
    ...
    if (isObjectPrototype(obj, prototype)) {
      return false;
    }
 ...
 *
 * @returns {*} A null-prototype copy, or the original non-object value
 */
const toSafeFlatObject = (thing) => {
  ...
  while (current != null) {
    ...
    if (isObjectPrototype(current, prototype)) {
      break;
    }
