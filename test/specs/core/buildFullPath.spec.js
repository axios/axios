...
describe('helpers::buildFullPath', function () {
  ...
  it('should combine the URLs when the requestedURL is absolute', function () {
    expect(buildFullPath('https://api.github.com', 'https://api.example.com/users')).toBe('https://api.github.com/https://api.example.com/users');
  });
