...
describe('utils::decodePathname', function () {
  ...
  it('OData with full URL: path should be decode', function () {
    var a = "https://services.odata.org/TripPinRESTierService/(S(djtqmgxgkc3viudbv33lqjxb))/People(%27russellwhyte%27)"
    var b = "https://services.odata.org/TripPinRESTierService/(S(djtqmgxgkc3viudbv33lqjxb))/People('russellwhyte')"
