...
describe('toFormData', () => {
  it('should convert nested data object to FormData with dots option enabled', () => {
    const o = {
      val: 123,
      nested: {
        arr: ['hello', 'world'],
  ...
  it('should respect metaTokens option', () => {
    const data = {
      'obj{}': { x: 1, y: 2 },
    };
  ...
  describe('Flat arrays serialization', () => {
    it('should include full indexes when the `indexes` option is set to true', () => {
      const data = {
        arr: [1, 2, 3],
        arr2: [1, [2], 3],
      };
    ...
    it('should include brackets only when the `indexes` option is set to false', () => {
      const data = {
        arr: [1, 2, 3],
        arr2: [1, [2], 3],
      };
    ...
    it('should omit brackets when the `indexes` option is set to null', () => {
      const data = {
        arr: [1, 2, 3],
        arr2: [1, [2], 3],
      };
  ...
  it('should convert nested data object to FormData', () => {
    const o = {
      val: 123,
      nested: {
        arr: ['hello', 'world'],
  ...
  it('should append value whose key ends with [] as separate values with the same key', () => {
    const data = {
      'arr[]': [1, 2, 3],
    };
  ...
  it('should append value whose key ends with {} as a JSON string', () => {
    const data = {
      'obj{}': { x: 1, y: 2 },
    };
